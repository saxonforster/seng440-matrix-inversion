...
fixed_multiply:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ not_optimized_fixedpoint.c:90:     product = (int32_t)first * (int32_t)second;
	mul	r1, r0, r1	@ product, tmp123, tmp124
@ not_optimized_fixedpoint.c:95:     if (product >= 0) {
	cmp	r1, #0	@ product,
@ not_optimized_fixedpoint.c:96:         product = product + (FIXED_ONE / 2);
	ite	ge
	addge	r1, r1, #2048	@ product, product,
@ not_optimized_fixedpoint.c:98:         product = product - (FIXED_ONE / 2);
	sublt	r1, r1, #2048	@ product, product,
@ not_optimized_fixedpoint.c:101:     return product / FIXED_ONE;
	addw	r0, r1, #4095	@ tmp121, product,
	ands	r0, r0, r1, asr #32	@ product, tmp121, product
	it	cc
	movcc	r0, r1	@ product, product
@ not_optimized_fixedpoint.c:102: }
...
fixed_divide:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ not_optimized_fixedpoint.c:123:     if (denominator == 0) {
	cmp	r1, #0	@ denominator
	beq	.L13		@,
@ not_optimized_fixedpoint.c:131:     scaled_numerator = (int32_t)numerator * FIXED_ONE;
	lsl	r3, r0, #12	@ scaled_numerator, numerator,
@ not_optimized_fixedpoint.c:138:     if (denominator_32 < 0) {
	blt	.L14		@,
@ not_optimized_fixedpoint.c:141:         half_denominator = denominator_32 / 2;
	asrs	r0, r1, #1	@ half_denominator, denominator,
@ not_optimized_fixedpoint.c:144:     if ((scaled_numerator >= 0 && denominator_32 > 0) || (scaled_numerator < 0 && denominator_32 < 0)) {
	cmp	r3, #0	@ scaled_numerator,
	blt	.L11		@,
.L10:
@ not_optimized_fixedpoint.c:145:         scaled_numerator += half_denominator;
	add	r3, r3, r0	@ scaled_numerator, half_denominator
@ not_optimized_fixedpoint.c:150:     *result = scaled_numerator / denominator_32;
	movs	r0, #1	@ <retval>,
@ not_optimized_fixedpoint.c:150:     *result = scaled_numerator / denominator_32;
...
@ not_optimized_fixedpoint.c:150:     *result = scaled_numerator / denominator_32;
	...
	bx	lr	@
.L14:
@ not_optimized_fixedpoint.c:139:         half_denominator = -denominator_32 / 2;
...
@ not_optimized_fixedpoint.c:144:     if ((scaled_numerator >= 0 && denominator_32 > 0) || (scaled_numerator < 0 && denominator_32 < 0)) {
	blt	.L10		@,
.L11:
@ not_optimized_fixedpoint.c:147:         scaled_numerator -= half_denominator;
...
@ not_optimized_fixedpoint.c:150:     *result = scaled_numerator / denominator_32;
	...
	bx	lr	@
.L13:
@ not_optimized_fixedpoint.c:124:         return 0;
	mov	r0, r1	@ <retval>, denominator
@ not_optimized_fixedpoint.c:153: }
	bx	lr	@
...
create_identity:
	...
	vldr	d26, .L18+16	@,
	vldr	d27, .L18+24	@,
@ not_optimized_fixedpoint.c:165:     for (row = 0; row < N; row++) {
	movs	r3, #0	@ row,
.L16:
...
@ not_optimized_fixedpoint.c:168:                 matrix[row][column] = FIXED_ONE;
...
@ not_optimized_fixedpoint.c:165:     for (row = 0; row < N; row++) {
	bne	.L16		@,
@ not_optimized_fixedpoint.c:174: }
	bx	lr	@
.L19:
	.align	3
.L18:
...
swap_rows:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ not_optimized_fixedpoint.c:185:         temporary = matrix[row1][column];
...
@ not_optimized_fixedpoint.c:186:         matrix[row1][column] = matrix[row2][column];
	ldrsh	ip, [r2, #2]!	@ _7, MEM[(short int *)_31]
@ not_optimized_fixedpoint.c:184:     for (column = 0; column < N; column++) {
	cmp	r3, r1	@ ivtmp.76, _34
@ not_optimized_fixedpoint.c:186:         matrix[row1][column] = matrix[row2][column];
	strh	ip, [r3]	@ movhi	@ _7, MEM[(short int *)_29]
@ not_optimized_fixedpoint.c:187:         matrix[row2][column] = temporary;
	strh	r0, [r2]	@ movhi	@ temporary, MEM[(short int *)_31]
@ not_optimized_fixedpoint.c:184:     for (column = 0; column < N; column++) {
	bne	.L21		@,
@ not_optimized_fixedpoint.c:189: }
	bx	lr	@
...
invert_matrix:
	...
	sub	sp, sp, #164	@,,
@ not_optimized_fixedpoint.c:230:             working[row][column] = input[row][column];
	add	r5, sp, #32	@ tmp294,,
@ not_optimized_fixedpoint.c:207: {
...
@ not_optimized_fixedpoint.c:239:     for (pivot_column = 0; pivot_column < N; pivot_column++) {
	mov	r6, r9	@ pivot_row, ivtmp.198
.L53:
@ not_optimized_fixedpoint.c:248:         largest_value = fixed_absolute(working[pivot_column][pivot_column]);
	ldrsh	r2, [r8]	@ _5, MEM[(short int *)_291]
@ not_optimized_fixedpoint.c:250:         for (row = pivot_column + 1; row < N; row++) {
	cmp	r6, #7	@ pivot_row,
@ not_optimized_fixedpoint.c:250:         for (row = pivot_column + 1; row < N; row++) {
...
@ not_optimized_fixedpoint.c:250:         for (row = pivot_column + 1; row < N; row++) {
	mov	r1, ip	@ row, row
.L27:
@ not_optimized_fixedpoint.c:251:             current_value = fixed_absolute(working[row][pivot_column]);
...
@ not_optimized_fixedpoint.c:255:                 pivot_row = row;
...
@ not_optimized_fixedpoint.c:250:         for (row = pivot_column + 1; row < N; row++) {
	cmp	r1, #8	@ row,
	bne	.L27		@,
@ not_optimized_fixedpoint.c:263:         if (largest_value == 0) {
	cmp	r0, #0	@ largest_value
	beq	.L31	@
@ not_optimized_fixedpoint.c:270:         if (pivot_row != pivot_column) {
...
@ not_optimized_fixedpoint.c:184:     for (column = 0; column < N; column++) {
	bne	.L33		@,
@ not_optimized_fixedpoint.c:279:         pivot_value = working[pivot_column][pivot_column];
	ldrsh	r2, [r8]	@ _5, MEM[(short int *)_291]
.L25:
@ not_optimized_fixedpoint.c:263:         if (largest_value == 0) {
	cmp	r2, #0	@ _5
	beq	.L31	@
@ not_optimized_fixedpoint.c:286:             if (!fixed_divide(working[pivot_column][column], pivot_value, &division_result)) {
	ldrsh	r3, [fp]	@ _107, MEM[(short int *)_297]
@ not_optimized_fixedpoint.c:138:     if (denominator_32 < 0) {
	cmp	r2, #0	@ _5,
	str	r4, [sp, #4]	@ ivtmp.211, %sfp
@ not_optimized_fixedpoint.c:133:     denominator_32 = denominator;
...
@ not_optimized_fixedpoint.c:62:     if (value < INT16_MIN || value > INT16_MAX) {
	...
	bcs	.L44		@,
.L39:
@ not_optimized_fixedpoint.c:294:             working[pivot_column][column] = (int16_t)division_result;
...
@ not_optimized_fixedpoint.c:62:     if (value < INT16_MIN || value > INT16_MAX) {
	cmp	r1, #65536	@ _89,
	bcs	.L44		@,
@ not_optimized_fixedpoint.c:307:             inverse[pivot_column][column] = (int16_t)division_result;
	strh	r3, [r0, #2]!	@ movhi	@ _175, MEM[(short int *)_20]
	add	r6, r10, #16	@ _296, ivtmp.208,
@ not_optimized_fixedpoint.c:281:         for (column = 0; column < N; column++) {
...
@ not_optimized_fixedpoint.c:62:     if (value < INT16_MIN || value > INT16_MAX) {
	...
	bcc	.L39		@,
.L44:
@ not_optimized_fixedpoint.c:291:                 return MATRIX_OVERFLOW;
	mov	r0, #-1	@ <retval>,
.L23:
@ not_optimized_fixedpoint.c:378: }
	add	sp, sp, #164	@,,
	@ sp needed	@
	pop	{r4, r5, r6, r7, r8, r9, r10, fp, pc}	@
.L31:
@ not_optimized_fixedpoint.c:264:             return MATRIX_SINGULAR;
	movs	r0, #0	@ <retval>,
@ not_optimized_fixedpoint.c:378: }
	add	sp, sp, #164	@,,
	@ sp needed	@
...
.L81:
	...
	str	r3, [sp, #4]	@ _78, %sfp
@ not_optimized_fixedpoint.c:317:         working[pivot_column][pivot_column] = FIXED_ONE;
	mov	r2, #4096	@ tmp275,
...
@ not_optimized_fixedpoint.c:324:         for (other_row = 0; other_row < N; other_row++) {
	movs	r1, #0	@ other_row,
@ not_optimized_fixedpoint.c:317:         working[pivot_column][pivot_column] = FIXED_ONE;
	mov	r2, r6	@ _296, _296
	mov	r8, r7	@ inverse, inverse
.L52:
@ not_optimized_fixedpoint.c:326:             if (other_row == pivot_column) {
	cmp	r1, r9	@ other_row, ivtmp.198
	beq	.L46		@,
@ not_optimized_fixedpoint.c:330:             elimination_factor = working[other_row][pivot_column];
	ldrsh	r0, [r3, r9, lsl #1]	@ elimination_factor, MEM[(short int *)_153 + ivtmp.198_276 * 2]
@ not_optimized_fixedpoint.c:335:             if (elimination_factor == 0) {
...
.L51:
@ not_optimized_fixedpoint.c:346:                 product = fixed_multiply(elimination_factor, working[pivot_column][column]);
	ldrsh	r3, [r6], #2	@ _16, MEM[(short int *)_147]
@ not_optimized_fixedpoint.c:348:                 updated_value = (int32_t)working[other_row][column] - product;
...
@ not_optimized_fixedpoint.c:354:                 working[other_row][column] = (int16_t)updated_value;
...
@ not_optimized_fixedpoint.c:96:         product = product + (FIXED_ONE / 2);
	it	ge
	addge	r1, r3, #2048	@ product, product,
@ not_optimized_fixedpoint.c:361:                 updated_value = (int32_t)inverse[other_row][column] - product;
...
@ not_optimized_fixedpoint.c:62:     if (value < INT16_MIN || value > INT16_MAX) {
	cmp	r1, #65536	@ _100,
	bcs	.L44		@,
@ not_optimized_fixedpoint.c:367:                 inverse[other_row][column] = (int16_t)updated_value;
	strh	r3, [ip, #2]!	@ movhi	@ updated_value, MEM[(short int *)_74]
@ not_optimized_fixedpoint.c:339:             for (column = 0; column < N; column++) {
	cmp	ip, lr	@ ivtmp.117, ivtmp.134
	bne	.L51		@,
@ not_optimized_fixedpoint.c:373:             working[other_row][pivot_column] = 0;
	...
	b	.L46		@
.L83:
@ not_optimized_fixedpoint.c:377:     return MATRIX_SUCCESS;
	movs	r0, #1	@ <retval>,
	b	.L23		@
.L85:
	.align	3
...
@ not_optimized_fixedpoint.c:389: {
	push	{r4, r5, lr}	@
@ not_optimized_fixedpoint.c:389: {
...
.L88:
@ not_optimized_fixedpoint.c:403:                 product = fixed_multiply(first[row][k], second[k][column]);
...
@ not_optimized_fixedpoint.c:402:             for (k = 0; k < N; k++) {
...
@ not_optimized_fixedpoint.c:404:                 sum += product;
...
@ not_optimized_fixedpoint.c:402:             for (k = 0; k < N; k++) {
	bne	.L88		@,
@ not_optimized_fixedpoint.c:407:             result[row][column] = sum;
	mov	r3, ip	@ tmp177, ivtmp.265
@ not_optimized_fixedpoint.c:397:     for (row = 0; row < N; row++) {
...
@ not_optimized_fixedpoint.c:397:     for (row = 0; row < N; row++) {
	bne	.L87		@,
@ not_optimized_fixedpoint.c:410: }
	pop	{r4, r5, pc}	@
...
matrix_infinity_norm:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ not_optimized_fixedpoint.c:420: {
	mov	r2, r0	@ tmp131, matrix
@ not_optimized_fixedpoint.c:427:     maximum_row_sum = 0;
	movs	r0, #0	@ <retval>,
	add	r1, r2, #128	@ _33, ivtmp.290,
.L93:
@ not_optimized_fixedpoint.c:433:             row_sum += fixed_absolute(matrix[row][column]);
...
@ not_optimized_fixedpoint.c:436:         if (row_sum > maximum_row_sum) {
	cmp	r0, r3	@ <retval>, _34
	it	lt
	movlt	r0, r3	@ <retval>, _34
@ not_optimized_fixedpoint.c:429:     for (row = 0; row < N; row++) {
	cmp	r2, r1	@ ivtmp.290, _33
	bne	.L93		@,
@ not_optimized_fixedpoint.c:442: }
	bx	lr	@
...
multiply_positive_q12:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ not_optimized_fixedpoint.c:458:     if (first < 0 || second < 0) {
	orrs	r3, r0, r1	@ tmp132, first, second
	bmi	.L99		@,
@ not_optimized_fixedpoint.c:462:     if (first != 0 && second > INT32_MAX / first) {
	cbz	r0, .L97	@ first,
@ not_optimized_fixedpoint.c:462:     if (first != 0 && second > INT32_MAX / first) {
...
@ not_optimized_fixedpoint.c:462:     if (first != 0 && second > INT32_MAX / first) {
	...
	bgt	.L99		@,
.L97:
@ not_optimized_fixedpoint.c:467:     product = first * second;
	mul	r3, r1, r0	@ product_13, second, first
@ not_optimized_fixedpoint.c:474:     return 1;
	movs	r0, #1	@ <retval>,
@ not_optimized_fixedpoint.c:472:     *result = product / FIXED_ONE;
...
@ not_optimized_fixedpoint.c:474:     return 1;
	bx	lr	@
.L99:
@ not_optimized_fixedpoint.c:459:         return 0;
	movs	r0, #0	@ <retval>,
@ not_optimized_fixedpoint.c:475: }
	bx	lr	@
...
@ not_optimized_fixedpoint.c:489: {
...
@ not_optimized_fixedpoint.c:498: }
	ldr	pc, [sp], #4	@
.L116:
@ not_optimized_fixedpoint.c:462:     if (first != 0 && second > INT32_MAX / first) {
